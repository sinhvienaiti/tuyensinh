...
<body class="bo">
		...
		<div class="container">
			...
			<form method="post" action="code_add_muc.php">
				...
				<input id="more"  type="submit" class="btn btn-success" name="more_muc" value="Thêm Mục" onclick="return add_muc()">
				<input id="huy" formaction="trangchu_muc_hienthi.php" type="submit" class="btn btn-success" name="back" value="Trở Lại">
				</form>
