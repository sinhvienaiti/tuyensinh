			...
			<form method="post">
				<table class="table table-hover ">
					...
					<tbody>
						 	...
						 	<td width="150">
						 		<input id="time" type="date" class="form-control positive-integer" name="time"  value="">
						 	</td>
					</tbody>
				</table>
				
				<input formaction="code_add_muc.php" type="submit" class="btn btn-success" name="more_nd_muc" value="Thêm Bài" id="more" onclick="return add_nd()">
				<input formaction="trangchu_nd_hienthi.php" type="submit" class="btn btn-success" name="back" value="Thêm Bài" >
				</form>
