					...
					<tbody>
						<tr>
							<td>
						 	...
						 	<td >
						 	<input  id="description" type="text" class="form-control " name="description" placeholder="Mô Tả"" value="">
							...
							<td>
								<input id="file" class=" pull-left form-control" type="file" name="file">
							</td>
							<td>
