...
<body class="bo">
		...
		<div class="container">
			...
			<div style="width: 36%; margin: 10px auto;">
				...
				<table class="table table-hover ">
					...
					<tbody>
						...
						<?php 
							...
							$select_e = "SELECT * FROM nganhnghe WHERE id = $g_edit";
						...
						?>
							...
							<td>
								<input  id="maloai" type="text" class="form-control positive-integer" name="maloai" placeholder="Nhập Mã Loại" value="<?php echo $row_e['id']; ?>" disabled="">
							</td>
							
							<td>
								<input  id="title" type="text" class="form-control" name="title" placeholder="Nhập Tên Ngành Nghề" value="<?php echo $row_e['name']; ?>">
							</td>
				...
				<input formaction="code_edit.php?edit=<?php echo $_GET['edit']; ?>" type="submit" class="btn btn-warning" name="edit_ten_nn" value="Sửa" onclick="return add_nn()">
				<input formaction="ten_nn.php" type="submit" class="btn btn-primary" name="back" value="Trở lại">
				</form>
