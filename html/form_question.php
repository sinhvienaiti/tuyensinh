	...
	<div class="container">
		<div style="width: 1018px; margin: 0px auto;">
			...
			/*	require_once('slider_content.php');*/
				...
				<?php 
				require_once("../php/code_content.php"); 
				?>
				 </div>
				 <div class="col-md-12">
					...
					<?php if($p > 1){ ?>
						<li style="cursor: pointer;">
							<a title="Previous" href="<?php echo $localhost; ?>/html/form_question.php?p=<?php echo $prew; ?>">
									Previous
							</a>
						</li>
					...
					<?php }
					 for($i=1;$i<=$all_table;$i++){ 
						...
						<li style="cursor: pointer;" class="<?php if($p == $i){echo 'active';} ?>">
							<a title="<?php echo $i; ?>" href="<?php echo $localhost; ?>/html/form_question.php?p=<?php echo $i; ?>">
								<?php echo $i; ?>
							</a>
						</li>
					<?php }
					...
					if($p < $all_table){ ?>
						<li style="cursor: pointer;">
							<a title="Next" style="cursor: pointer;" href="<?php echo $localhost; ?>/html/form_question.php?p=<?php echo $next; ?>">
								Next
							</a>
						</li>
						<?php } ?>
