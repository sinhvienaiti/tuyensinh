	...
	<div class="container">
		<div style="width: 1018px; margin: 0px auto;">
			...
			<div  style="width: 74%;float: left; background:#fff; margin:10px 0px 0px 0px; padding-bottom: 100px;">
				...
				?>
				<div>
					<h2 style="font-size: 22px; font-family: Tahoma; font-weight: bold; margin: 20px 20px 20px 20px; color: #114682; border-bottom: 2px solid red; padding-bottom: 20px;">
						Tin tức - sự kiện
					</h2>
				</div>
				<div>
				<?php 
				require_once("../php/code_tintuc.php"); 
				?>
				 </div>
				 <div class="col-md-12">
					...
					<?php if($p > 1){ ?>
						<li style="cursor: pointer;">
							<a title="Previous" href="<?php echo $localhost; ?>/html/form_tintuc.php?p=<?php echo $prew; ?>">
									Previous
							</a>
						</li>
					...
					<?php }
					 for($i=1;$i<=$all_table;$i++){ 
						...
						<li style="cursor: pointer;" class="<?php if($p == $i){echo 'active';} ?>">
							<a title="<?php echo $i; ?>" href="<?php echo $localhost; ?>/html/form_tintuc.php?p=<?php echo $i; ?>">
								<?php echo $i; ?>
							</a>
						</li>
					<?php }
					...
					if($p < $all_table){ ?>
						<li style="cursor: pointer;">
							<a title="Next" style="cursor: pointer;" href="<?php echo $localhost; ?>/html/form_tintuc.php?p=<?php echo $next; ?>">
								Next
							</a>
						</li>
						<?php } ?>
