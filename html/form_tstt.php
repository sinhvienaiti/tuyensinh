		...
		<div style="width: 1200px; margin: 0px auto;">
			...
			<section>
				...
				<div class="col-md-12" style="margin: 10px 0px; padding: 0px;">
					...
					<br>
					<p>
						Sau khi có kết quả kỳ thi Trung học phổ thông (THPT) quốc gia (hoặc kết quả học tập ở bậc THPT/THBT) thí sinh có thể đăng ký xét tuyển trực tuyến vào trường Cao đẳng cộng dồng Hà Nội thông qua hệ thống này.
					</p>
					<p>
...
<script type='text/javascript' src='../diapo/scripts/diapo.js'></script> 
   ...
   <div style="overflow:hidden; width:400px;   display: block;
	...
	position: relative;"> 
		...
		<div class="col-md-4" style="padding: 0px; margin-left: 20px; margin-right: 0px; margin-top: -4px;">
			<div class="col-md-12" style="padding: 0px;">
				<div class="img">
					<img  src="<?php echo $localhost; ?>/img/hdtt/Hieu mau TN1.jpg" alt="picture">
				</div>
				<div class="img">
			...
			<div class="col-md-12" style="padding: 0px;">
				<div class="img">
					<img src="../img/hdtt/IMG_7573-min.jpg" alt="picture">
				</div>
				<div class="img">
					<img src="../img/hdtt/IMG_7610-min.jpg" alt="picture">
				</div>
				<div class="img">
			...
			<div class="col-md-12" style="padding: 0px;">
				<div class="img">
					<img src="../img/hdtt/IMG_7551-min.jpg" alt="picture">
				</div>
				<div class="img">
					<img src="../img/hdtt/IMG_7574-min.jpg" alt="picture">
				</div>
				<div class="img">
					<img src="../img/hdtt/IMG_7580-min.jpg" alt="picture">
				</div>
			</div>
		</div>
	...
	<div style="position: fixed; width: 100px; top: 30%; ">
		...
		<div class="fb-like" data-href="<script> window.location.href </script>" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
	<script type="text/javascript">
