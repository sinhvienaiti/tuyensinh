		...
		<div style="width: 1018px; margin: 0px auto;">
			...
			<div  style="width: 74%;float: left; background:#fff; margin:10px 0px 0px 0px; padding-bottom: 100px;">
				...
				<div class="col-md-12">
					...
					<div class="col-md-12">
						<input class="form-control" type="text" name="" value="Tầng 1 Khu Nhà Hiệu Bộ - Số 102 Trung Kính - P. Yên Hòa - Q. Cầu Giấy - TP. Hà Nội" disabled="">
					</div>
				</div>
				<div class="col-md-12" style="margin-top: 30px;">
					...
					<div class="col-md-8">
						<input class="form-control" type="text" name="" value="04.3784.5153" disabled="">
					</div>
				</div>
				<div class="col-md-12" style="margin-top: 30px;">
					<div class="col-md-2">
					...
					<div class="col-md-8">
						<input class="form-control" type="text" name="" value="0912.024.743" disabled="">
					</div>
				</div>	
				<div class="col-md-12" style="margin-top: 30px;">
					<div class="col-md-2">
					...
					<div class="col-md-8">
						<a href="http://tuyensinh.chn.edu.vn/" title="">http://www.tuyensinh.chn.edu.vn</a>
					</div>
				</div>	
				<div class="col-md-12" style="margin-top: 30px;">
					<div class="col-md-2">
					...
					<div class="col-md-8">
						<a href="" title="bantuyensinh@chn.edu.vn; daotao@chn.edu.vn">bantuyensinh@chn.edu.vn; daotao@chn.edu.vn</a> 
					</div>
				</div>	
				<div class="col-md-12" style="margin-top: 40px;">
					...
					<div style="width: 430px; height: 340px; margin: 50px auto;">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.4009764474436!2d105.7926271153678!3d21.016636093567044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab59c532b239%3A0x70a9972a37924213!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEPhu5luZyDEkeG7k25nIEjDoCBO4buZaQ!5e0!3m2!1svi!2s!4v1488184054225" width="430" height="340" frameborder="0" style="border:0" allowfullscreen></iframe>
					</div>
				</div>
				 </div>
