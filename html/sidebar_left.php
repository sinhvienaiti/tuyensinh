	...
	<aside >
			...
			<ul id="menu_left">
							...
							<li>
								...
								chương trình đào tạo <i style="float: right;" class="fa fa-chevron-right" aria-hidden="true"></i>
								</a>
								
								<ul>
									<li>
										<a href="<?php echo $localhost; ?>/html/caodangchinhquy.php" title="">
											Cao Đẳng chính quy
										</a>
									</li>
									<li>
										<a href="<?php echo $localhost; ?>/html/caodanglienthong.php" title="">
											cao đẳng liên thông
										</a>
									</li>
									<li>
										<a href="<?php echo $localhost; ?>/html/trungcapnghenghiep.php" title="">
							...
							<li>
								<a href="<?php echo $localhost; ?>/html/form_thongbao_rows.php" title="Các Khoa Đào Tạo">
									Thông Báo <img src="<?php echo $localhost; ?>/img/quangcao/logo/icon-new.gif" alt="picture"><i style="float: right;" class="fa fa-chevron-right" aria-hidden="true"></i>
								</a>
								<ul>
								<?php
											require_once('../php/connect.php');
											$select = "SELECT * FROM thongbao ORDER BY id DESC LIMIT 0,5";
											...
											?>
									<li>
										<a href="<?php echo $localhost; ?>/html/form_thongbao.php?id_thongbao=<?php echo $row['id']; ?>" title="<?php echo $row['title']; ?>">
							...
							<li>
								<a href="<?php echo $localhost; ?>/html/form_all_nn.php" title="Các Khoa Đào Tạo">
									Các Khoa Đào Tạo  <i style="float: right;" class="fa fa-chevron-right" aria-hidden="true"></i>
								</a>
								<ul>
								<?php
											require_once('../php/connect.php');
							...
							<li>
								<a href="" title="Quy chế đào tạo">
									tư vấn tuyển sinh <i style="float: right;" class="fa fa-chevron-right" aria-hidden="true"></i>
								</a>
								<ul>
							...
							<li>
								<a href="<?php echo $localhost; ?>/html/form_cctc.php" title="cơ cấu tổ chức">
									cơ cấu tổ chức <i style="float: right;" class="fa fa-chevron-right" aria-hidden="true"></i>
								</a>
							</li>
							<li style="background: black; color: #fff;">
								<a href="<?php echo $localhost; ?>/html/form_tracuu.php" title="Tra Cứu Văn Bằng Tốt Nghiệp">
									<i style="float: right;" class="fa fa-folder-open-o" aria-hidden="true"></i>  Tra Cứu Văn Bằng TN 
								</a>
							</li>
			...
			<div class="col-md-12" style="padding: 5px 0px">
					<a href="http://www.khoaketoan.chn.edu.vn"><img style="width: 100%;" src="<?php echo $localhost; ?>/img/quangcao/logo/3.gif" alt="picture"></a>
			</div><div class="col-md-12" style="padding: 5px 0px">
			<div class="col-md-12" style="padding: 5px 0px">
					<a href="http://www.cntt.chn.edu.vn"><img style="width: 100%;" src="<?php echo $localhost; ?>/img/quangcao/logo/2.gif" alt="picture"></a>
			</div>
					<a href="http://www.tcnh.chn.edu.vn"><img style="width: 100%;" src="<?php echo $localhost; ?>/img/quangcao/logo/4.gif" alt="picture"></a>
			</div>
			<div class="col-md-12" style="padding: 5px 0px">
					<a href="http://www.xaydung.chn.edu.vn"><img style="width: 100%;" src="<?php echo $localhost; ?>/img/quangcao/logo/1.gif" alt="picture"></a>
			</div>
			
			
			
			<div class="col-md-12" style="padding: 5px 0px">
					<a href=""><img style="width: 100%;" src="<?php echo $localhost; ?>/img/quangcao/logo/thithu.gif" alt="picture"></a>
			</div>
