...
<body class="bo">
		...
		<div class="container">
			...
			<div style="width: 36%; margin: 10px auto;">
				...
				<table class="table table-hover ">
					...
					<tbody>
						<tr>
							...
							<td>
								<input  id="title" type="text" class="form-control" name="title" placeholder="Nhập Tên Ngành Nghề" value="">
							</td>
				...
				<input formaction="code_add_muc.php" type="submit" class="btn btn-warning" name="more_nn" value="Thêm Mục" onclick="return add_nn()">
