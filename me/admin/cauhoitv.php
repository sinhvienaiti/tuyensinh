		...
		<div class="container">
			...
			<div style="width: 50%; margin: 10px auto;">
				...
				<table class="table table-hover ">
					...
					<tbody>
						<?php
							require_once('code_cauhoitv.php');
						?>
					</tbody>
				</table>
				<form method="post">
				<input formaction="add_cauhoitv.php" type="submit" class="btn btn-success" name="more_cauhoitv" value="Thêm bài" id="more_make_question">
				</form>
				<div class="container" >
				<div class="row text-center">
					...
					<?php if($p > 1){ ?>
						<li style="cursor: pointer;">
							<a  href="http://localhost/tuyensinh/admin/cauhoitv.php?p=<?php echo $prew; ?>">
									Previous
							</a>
						</li>
					...
					<?php }
					 ...
					 for($i=1;$i<=$all_table;$i++){ 
						...
						<li style="cursor: pointer;" class="<?php if($p == $i){echo 'active';} ?>">
							<a href="http://localhost/tuyensinh/admin/cauhoitv.php?p=<?php echo $i; ?>">
								<?php echo $i; ?>
							</a>
						</li>
					<?php }
					...
					if($p < $all_table){ ?>
						<li style="cursor: pointer;">
							<a style="cursor: pointer;" href="http://localhost/tuyensinh/admin/cauhoitv.php?p=<?php echo $next; ?>">
								Next
							</a>
						</li>
						<?php } ?>
