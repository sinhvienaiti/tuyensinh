			...
			<form method="post">
				<table class="table table-hover ">
					...
					$g_edit = (int)$_GET['edit'];
						$select_e = "SELECT * FROM tuyensinh WHERE id = $g_edit";
						...
						<tr>
							<td width="250">
						 		<textarea  id="title" type="text" class="form-control" name="title" placeholder="Nhập Tiêu Đề" value="" rows="10"><?php echo $row_e['questions']; ?></textarea>
						 		
						 	</td>
						 	<td width="250">
						 		<textarea  id="content" type="text" class="form-control" name="content" placeholder="Nhập Nội Dung" value="" rows="10"><?php echo $row_e['answer']; ?></textarea>
				...
				<input formaction="code_edit.php?edit=<?php echo $_GET['edit'] ?>" type="submit" class="btn btn-warning" name="edit_cauhoitv" value="Thêm bài" id="edit_cauhoitv" onclick="return add_cauhoitv()">
