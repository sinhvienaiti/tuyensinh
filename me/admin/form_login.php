...
<body class="bo">
			...
			<div style="width:60%; margin: 40px auto; margin-top: 20%; border: 2px solid #9fb90e; padding: 100px; border-radius: 15px; background: url(../img/quangcao/logo/logo_bg.jpg) no-repeat right center; background-color: #fff;">
			 ...
			 <div class="form-group col-md-12">
			 	...
			 	<div class="col-xs-7">
			 		<input class="form-control" type="text" name="taikhoan" placeholder="nhập tài khoản" value="<?php if(isset($_SESSION['txtusername'])){ echo $_SESSION['txtpassword'];} ?>">
			 	</div>
			 </div>
			 ...
			 <div class="form-group col-md-12">
			 	...
			 	<div class="col-xs-7">
			 		<input class="form-control" type="text" name="matkhau" placeholder="nhập tài khoản" value="<?php if(isset($_SESSION['txtpassword'])){ echo $_SESSION['txtpassword'];} ?>">
			 	</div>
			 </div>
			 <div class="form-group">
			 	<label class="control-label col-xs-offset-1"><input type="checkbox" name="save" <?php if(isset($_SESSION['save'])){ echo "checked";} ?>>Ghi nhớ</label>
			 </div>
			 <div class="form-group col-md-12">
