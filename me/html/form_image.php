...
<div data-b="0">
<img data-u="image" src="<?php echo $localhost; ?>/img/hdtt/11013067_1142373232444279_4888709019296571777_n.jpg" alt="picture" />
				...
				$select_title = "SELECT * FROM thongbao WHERE id = 132";
				 ...
				 <div style="width: 740px; margin: 20px; margin-left: -10px;">
					  ...
					  <div style="width: 220px; float: left; margin-top: 30px;">
					  	<img  src="<?php echo $localhost; ?>/img/hdtt/IMG_7573-min.jpg?>" style="border-radius: 20px;width: 200px; height: 200px; float: left;" alt="picture">
