	...
	<aside >
			...
			<ul id="menu_left">
							<li style="background: red; color: #fff;">
									...
									<a href="http://www.sv.chn.edu.vn/Default.aspx" title="Cổng Thông Hin Học Sinh - Sinh Viên">
									  Cổng Thông Tin SV <i style="font-size: 22px; float: right;" class="fa fa-bars" aria-hidden="true"></i>
							...
							<li>
								<a href="<?php echo $localhost; ?>/html/form_tracuu.php" title="Tra Cứu Văn Bằng Tốt Nghiệp">
									Tra Cứu Văn Bằng TN <span style="float: right;" class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
								</a>
							</li>
							
							<li style="background: black; color: #fff;">
								<a href="" title="Cổng Thông Tin CBVC">
									<span style="float: right;" class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> Cổng Thông Tin CBVC
								</a>
							</li>
