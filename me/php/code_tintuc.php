				 ...
				 <div style="width: 740px;">
					<div >
					  <h2 class="col-md-12" style="margin-left: 30px;
								...
								top:24px;
								width: 700px;">
					  	<a style="z-index: 9999; color: #0484a2;" href="<?php echo $localhost; ?>/html/form_in_tintuc.php?id_tt=<?php echo $row_title['id']; ?>" title="<?php echo $row_title['title']; ?>"><?php echo $row_title['title']; ?> </a>
					  </h2>
					 </div>
					  <div class="col-md-12">
