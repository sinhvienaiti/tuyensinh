...
<div>
<img data-u="image" src="img/hdtt/IMG_7629-min.jpg" alt="picture" />
...
<div>
<img data-u="image" src="img/hdtt/IMG_7543-min.jpg" alt="picture" />
...
<div data-b="0">
<img data-u="image" src="img/hdtt/11013067_1142373232444279_4888709019296571777_n.jpg" alt="picture" />
<div data-u="caption" data-t="7" style="position:absolute;top:-50px;left:30px;width:350px;height:30px;z-index:0;background-color:rgba(235,81,0,0.5);font-size:20px;color:#ffffff;line-height:30px;text-align:center;">tiết mục văn nghệ  </div>
</div>
<div data-p="112.50">
<img data-u="image" src="img/hdtt/11014850_1092270950787841_7082189756443345381_n.jpg" alt="picture" />
...
<div data-p="112.50">
<img data-u="image" src="img/hdtt/Hieu mau TN1.jpg" alt="picture" />
...
<script type="text/javascript">jssor_1_slider_init();</script>
			...
			<div style="padding-bottom: 30px;  ">
				<h1 style="margin: 30px;" >
					...
					<span class="test" style="font-weight: bold; width: 25%; float: left;"> Thông báo :</span> <marquee style="width: 65%; float: left;"> <span style=" font-style: italic; color: black;"> Tuyển Sinh trực tuyến 2017 tại <a href="<?php echo $localhost; ?>/html/form_tstt.php" title="" >Tuyensinh.chn.edut.vn</a> </span></marquee>
				</h1>
				<?php
				...
				$select_title = "SELECT * FROM thongbao WHERE id = 132";
				 ...
				 <div style="width: 740px; margin: 20px; margin-left: -10px;">
					  ...
					  <div style="width: 220px; float: left; margin-top: 30px;">
					  	<img  src="img/hdtt/IMG_7573-min.jpg?>" style="border-radius: 20px;width: 200px; height: 200px; float: left;" alt="picture">
