...
<?php
				 ...
				 ?>
					  <div class="panel panel-default" style="margin-bottom: 10px;">
					    <div style="background: red;" class="panel-heading" role="tab" id="headingTwo1<?php echo $i; ?>">
					      <h4 class="panel-title" style="background: red;"		>
					        <a style="background: red;" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo<?php echo $i; ?>" aria-expanded="false" aria-controls="collapseTwo1">
