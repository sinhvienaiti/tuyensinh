...
ul#menu_left li a{
	...
	<aside >
			...
			<ul id="menu_left">
							...
							<li>
								<a href="<?php echo $localhost; ?>/html/form_thongbao_rows.php" title="Các Khoa Đào Tạo">
									Thông Báo <img src="<?php echo $localhost; ?>/img/icon-new.gif" alt="picture"><i style="float: right;" class="fa fa-chevron-right" aria-hidden="true"></i>
								</a>
								<ul>
								<?php
			...
			<div class="col-md-12" style="padding: 5px 0px">
					<a href="http://www.khoaketoan.chn.edu.vn"><img style="width: 100%;" src="img/3.gif" alt="picture"></a>
			</div><div class="col-md-12" style="padding: 5px 0px">
			<div class="col-md-12" style="padding: 5px 0px">
					<a href="http://www.cntt.chn.edu.vn"><img style="width: 100%;" src="img/2.gif" alt="picture"></a>
			</div>
					<a href="http://www.tcnh.chn.edu.vn"><img style="width: 100%;" src="img/4.gif" alt="picture"></a>
			</div>
			<div class="col-md-12" style="padding: 5px 0px">
					<a href="http://www.xaydung.chn.edu.vn"><img style="width: 100%;" src="img/1.gif" alt="picture"></a>
			</div>
			
			
			
			<div class="col-md-12" style="padding: 5px 0px">
					<a href=""><img style="width: 100%;" src="img/thithu.gif" alt="picture"></a>
			</div>
